...
import { subirParteB,descargarParteB } from '../service/apiArchivo';
    ...
    const linkBodyTemplate = (rowData) => {
        return (
            <>
                ...
                <Button label="Descargar" className="p-button-link" onClick={descargarParteB} style={props.layoutColorMode === 'light' ? {'color':'#495057', 'font-weight': 'bold' , 'text-align': 'justify'} : {'color':'#ffffff', 'font-weight': 'bold' , 'text-align': 'justify'}}/>      
            </>
        );
    }
